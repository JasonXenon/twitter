<x-guest-layout>
    ...
    <form method="GET" action="{{ route('index') }}" class="flex items-center justify-end px-3">
        <input type="text" name="query" placeholder="Rechercher des tweets ou des personnes" class="mr-2" value="{{ request()->query('query') }}">
